      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto space-y-6 animate-fade-in">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-neutral-900 text-neutral-400 border border-neutral-800 font-medium">
                  {session.targetRole}
                </span>
              </div>
        ...
        <div className="card-gradient-yellow rounded-3xl p-6 sm:p-8 space-y-5">
          <div className="flex items-center justify-between gap-4">
            ...
            <span className="text-xs text-neutral-500">Q {currentIdx+1}/{session.questions.length}</span>
          </div>
